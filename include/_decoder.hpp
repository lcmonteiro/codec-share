...
class decoder
{
  public:
	...
	/// @param capacity
	/// @param token
	decoder(size_t capacity, _token::shared::Stamp token = _token::get(_token::Type::FULL))
	...
	/// @param init
	/// @param token
	decoder(size_t capacity, Container init, _token::shared::Stamp token)
	...
	/// @param data
	/// @param token
	decoder(Container data, _token::shared::Stamp token = _token::get(_token::Type::FULL))
