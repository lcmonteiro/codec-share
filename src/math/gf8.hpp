...
static const int V2P[]        = {
  512, 0,   1,   25,  2,   50,  26,  198, 3,   223, 51,  238, 27,  104, 199, 75,  4,   100, 224,
...
static const int P2V[] = {
  ...
  96,  192, 157, 39,  78,  156, 37,  74,  148, 53,  106, 212, 181, 119, 238, 193, 159, 35,  70,
  140, 5,   10,  20,  40,  80,  160, 93,  186, 105, 210, 185, 111, 222, 161, 95,  190, 97,  194,
  153, 47,  94,  188, 101, 202, 137, 15,  30,  60,  120, 240, 253, 231, 211, 187, 107, 214, 177,
  127, 254, 225, 223, 163, 91,  182, 113, 226, 217, 175, 67,  134, 17,  34,  68,  136, 13,  26,
  52,  104, 208, 189, 103, 206, 129, 31,  62,  124, 248, 237, 199, 147, 59,  118, 236, 197, 151,
  51,  102, 204, 133, 23,  46,  92,  184, 109, 218, 169, 79,  158, 33,  66,  132, 21,  42,  84,
  168, 77,  154, 41,  82,  164, 85,  170, 73,  146, 57,  114, 228, 213, 183, 115, 230, 209, 191,
  ...
  56,  112, 224, 221, 167, 83,  166, 81,  162, 89,  178, 121, 242, 249, 239, 195, 155, 43,  86,
  172, 69,  138, 9,   18,  36,  72,  144, 61,  122, 244, 245, 247, 243, 251, 235, 203, 139, 11,
  22,  44,  88,  176, 125, 250, 233, 207, 131, 27,  54,  108, 216, 173, 71,  142, 0,   0,   0,
...
static inline auto div(Number a, Number b) {
    if (a == 0) {
        return 0;
    }
    int x = V2P[a] - V2P[b];
...
template <typename Number>
static inline auto mul(Number a, Number b) {
    if (a == 0 || b == 0) {
        return 0;
    }
...
static inline Container& mul(Container& b, Number m) {
    if (m == 0) {
...
template <typename Container, typename Number>
static inline Container& mul(Container& b, Number m, size_t i) {
    if (m == 0) {
...
static inline Container& sum(Container& a, Container& b) {
...
template <typename Container>
static inline Container& sum(Container& a, Container& b, size_t i) {
